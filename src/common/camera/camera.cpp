...
glm::mat4 Camera::get_view_transformation() {
...
void Camera::update_camera_vectors() {
    ...
    camera_right_axis = glm::normalize(glm::cross(camera_front, world_up));  // normalize the vectors, because their length gets closer to 0 the more you look up or down which results in slower movement.
