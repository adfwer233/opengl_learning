    ...
    /*
        ...
        Alogrithm: 
            Step1: Finding all intersect points of both polygons, judge type (in or out) and create vertex array
                Step 1.1: for edges in poly and construct vertices array1
                Step 1.2: for edges in window and construct vertices array2
                Step 1.3: construct double-sided pointers between both array (points in some tolarance are considered same)
